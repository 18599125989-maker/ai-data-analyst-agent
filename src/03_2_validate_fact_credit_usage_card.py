...
"""
功能：
验证 knowledge_manual/table_cards_draft/fact_credit_usage.yaml 中的核心假设。

输出：
outputs/knowledge/validation/
├── fact_credit_usage_validation.json
└── fact_credit_usage_validation.md
"""

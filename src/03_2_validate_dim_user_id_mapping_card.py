...
"""
功能：
验证 knowledge_manual/table_cards_draft/dim_user_id_mapping.yaml 中的核心假设。

输出：
outputs/knowledge/validation/
├── dim_user_id_mapping_validation.json
└── dim_user_id_mapping_validation.md
"""
...
JSON_OUTPUT = OUTPUT_DIR / "dim_user_id_mapping_validation.json"
MD_OUTPUT = OUTPUT_DIR / "dim_user_id_mapping_validation.md"
...
NUMERIC_COLUMNS = []
JSON_COLUMNS = []
SQL_PATTERNS = {'join_coverage_sample': 'SELECT\n    COUNT(*) AS row_count\nFROM dim_user_id_mapping base\nLEFT JOIN dim_user ref\n    ON base.user_id = ref.user_id;'}

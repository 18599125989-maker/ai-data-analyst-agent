...
"""
功能：
验证 knowledge_manual/table_cards_draft/fact_campaign.yaml 中的核心假设。

输出：
outputs/knowledge/validation/
├── fact_campaign_validation.json
└── fact_campaign_validation.md
"""
